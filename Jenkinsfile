...
node { // <1>
  ...
  stage('Upload') {
    ...
    nexusArtifactUploader artifacts: [[artifactId: 'Ramesh', classifier: '', file: '/var/lib/jenkins/workspace/an-example-first-pipeline-scm/target/surefire-reports/TEST-com.mkyong.web.controller.TestDocker.xml', type: 'xml']], credentialsId: '72dd7897-d032-42bc-bc07-42b0f58d9185', groupId: 'org.jenkins-ci.main', nexusUrl: '13.55.146.108:8085/nexus', nexusVersion: 'nexus2', protocol: 'http', repository: 'releases',version: '${BUILD_NUMBER}'
    //nexusArtifactUploader credentialsId: 'Nexus', groupId: 'org.jenkins-ci.main', nexusUrl: '13.55.146.108:8085/nexus', nexusVersion: 'nexus2', protocol: 'http', repository: 'releases',version: '${BUILD_NUMBER}'
  }
